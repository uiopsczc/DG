...
/// </summary>
[Serializable]
public static class MultiTagsUtil
{
	/* MultiTags :
   *
   *	#####################
  ...
  */
	...
	/// </summary>
	public static readonly string[] BuiltInTagsNames = new string[7] { "Untagged", "Respawn", "Finish", "EditorOnly", "MainCamera", "User", "GameController" };
