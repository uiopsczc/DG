...
public class CreateTagWindow : EditorWindow
{
  ...
  */
  ...
  private void DrawEditor()
  {
    ...
    {
      EditorGUILayout.HelpBox("The name of the tag cannot contains \'" + MultiTagsUtil.TAG_SEPARATOR + "\'.", MessageType.Warning);
    }
  ...
  private void CheckName()
  {
    ...
    if (tagName.Contains(MultiTagsUtil.TAG_SEPARATOR))
    {
