...
*/
  ...
  private void ConnectProjectTags()
  {
    ...
    List<string> _projectMultiTags = _projectTags.SelectMany(t => t.Split(MultiTagsUtil.TAG_SEPARATOR)).Distinct().ToList();
    ...
    {
      if (MultiTagsUtil.BuiltInTagsNames.Contains(_tag))
      {
