...
namespace DG
{
	...
	public struct FPMatrix2x3
	{
		...
		public FPMatrix2x3(FP sm11, FP sm12, FP sm13, FP sm21, FP sm22, FP sm23)
		{
			SM11 = sm11;
			SM12 = sm12;
			SM13 = sm13;
		...
		*************************************************************************************/
		...
		public static FPMatrix2x3 Add(FPMatrix2x3 a, FPMatrix2x3 b)
		{
		...
		public static FPMatrix2x3 Multiply(FPMatrix2x3 a, FPMatrix3x3 b)
		{
			FPMatrix2x3 result = default;
		...
		/// <param name="b">Second matrix to multiply.</param>
		/// <param name="result">Product of the multiplication.</param>
		public static FPMatrix2x3 Multiply(FPMatrix2x3 a, FPMatrix4x4 b)
		{
			FPMatrix2x3 result = default;
			FP resultM11 = a.SM11 * b.sm11 + a.SM12 * b.sm21 + a.SM13 * b.sm31;
			FP resultM12 = a.SM11 * b.sm12 + a.SM12 * b.sm22 + a.SM13 * b.sm32;
		...
		public static FPMatrix2x3 Negate(FPMatrix2x3 matrix)
		{
			FPMatrix2x3 result = default;
			FP m11 = -matrix.SM11;
			FP m12 = -matrix.SM12;
		...
		public static FPMatrix2x3 Subtract(FPMatrix2x3 a, FPMatrix2x3 b)
		{
			FPMatrix2x3 result = default;
			FP m11 = a.SM11 - b.SM11;
			FP m12 = a.SM12 - b.SM12;
		...
		public static FPVector3 Transform(FPVector2 v, FPMatrix2x3 matrix)
		{
		...
		public static FPVector2 Transform(FPVector3 v, FPMatrix2x3 matrix)
		{
		...
		public static FPMatrix3x2 Transpose(FPMatrix2x3 matrix)
		{
