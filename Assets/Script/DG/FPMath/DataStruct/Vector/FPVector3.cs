...
namespace DG
{
    public partial struct FPVector3
    {
        ...
        public static FPVector3 RotateTowards(FPVector3 current, FPVector3 target, FP maxRadiansDelta,
            FP maxMagnitudeDelta)
        {
            ...
            FP smoothTime, FP maxSpeed, FP deltaTime)
        {
            ...
            if (origMinusCurrentX * outMinusOrigX + origMinusCurrentY * outMinusOrigY +
