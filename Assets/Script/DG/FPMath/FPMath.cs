...
namespace DG
{
    public static partial class FPMath
    {
        ...
        public static bool LineIntersection(FPVector2 p1, FPVector2 p2, FPVector2 p3, FPVector2 p4,
        ...
        public static bool LineSegmentIntersection(FPVector2 p1, FPVector2 p2, FPVector2 p3, FPVector2 p4,
            ref FPVector2 result)
        {
            FP bx = p2.x - p1.x;
            FP by = p2.y - p1.y;
