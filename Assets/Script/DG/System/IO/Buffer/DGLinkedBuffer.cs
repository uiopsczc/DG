...
namespace DG
{
    public class DGLinkedBuffer : DGBuffer
    {
        ...
        /// <returns></returns>
        public DGLinkedBuffer(int minBufferUnitSize)
        {
        ...
        /// <returns></returns>
        public override void Append(DGByteBuffer bbf)
        {
        ...
        /// <param name="bbf"></param>
        /// <returns></returns>
        public override void Pop(DGByteBuffer bbf)
        {
            var len = bbf.Remaining();
            Get(0, bbf);
            _firstOffset += len;
        ...
        /// <param name="bbf"></param>
        /// <returns></returns>
        public override void Set(int pos, DGByteBuffer bbf)
        {
        ...
        /// <param name="bbf"></param>
        /// <returns></returns>
        public override void Get(int pos, DGByteBuffer bbf)
        {
