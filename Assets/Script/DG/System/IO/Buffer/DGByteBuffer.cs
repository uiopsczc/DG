...
namespace DG
{
	public class DGByteBuffer : MemoryStream
	{
		...
		/// <param name="b"></param>
		/// <returns></returns>
		public DGByteBuffer Put(byte b)
		{
			CheckBounds(0, 1, 1);
			WriteByte(b);
			return this;
		...
		/// <param name="b"></param>
		/// <returns></returns>
		public DGByteBuffer Put(int index, byte b)
		{
		...
		/// <returns></returns>
		public DGByteBuffer Put(DGByteBuffer src)
		{
			if (src == this)
		...
		/// <param name="length"></param>
		/// <returns></returns>
		public DGByteBuffer Put(byte[] src, int offset, int length)
		{
		...
		/// <param name="src"></param>
		/// <returns></returns>
		public DGByteBuffer Put(byte[] src)
		{
		...
		/// <param name="src"></param>
		/// <returns></returns>
		public DGByteBuffer Put(int index, byte[] src)
		{
		...
		/// <returns></returns>
		public DGByteBuffer PutChar(char value)
		{
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutChar(int index, char value)
		{
			var data = value.ToBytes();
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutShort(short value)
		{
			var data = value.ToBytes();
			return Put(data);
		}

		public DGByteBuffer PutShort(int value)
		{
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutShort(int index, short value)
		{
			var data = value.ToBytes();
			return Put(index, data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutInt(int value)
		{
			var data = value.ToBytes();
			return Put(data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutInt(int index, int value)
		{
			var data = value.ToBytes();
			return Put(index, data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutLong(long value)
		{
			var data = value.ToBytes();
			return Put(data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutLong(int index, long value)
		{
			var data = value.ToBytes();
			return Put(index, data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutFloat(float value)
		{
			var data = value.ToBytes();
			return Put(data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutFloat(int index, float value)
		{
			var data = value.ToBytes();
			return Put(index, data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutDouble(double value)
		{
			var data = value.ToBytes();
			return Put(data);
		}
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public DGByteBuffer PutDouble(int index, double value)
		{
			var data = value.ToBytes();
			return Put(index, data);
		}
		...
		/// <param name="length"></param>
		/// <returns></returns>
		public DGByteBuffer Get(byte[] dst, int offset, int length)
		{
		...
		/// <param name="dst"></param>
		/// <returns></returns>
		public DGByteBuffer Get(byte[] dst)
		{
