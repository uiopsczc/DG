...
namespace DG
{
	public abstract class DGBuffer
	{
		/// <summary>
		///   网络字节顺序BIG_ENDIAN
		/// </summary>
		...
		/// <returns></returns>
		public abstract void Set(int pos, DGByteBuffer bbf);
		...
		/// <param name="bbf"></param>
		/// <returns></returns>
		public abstract void Get(int pos, DGByteBuffer bbf);
		...
		/// <param name="bbf"></param>
		/// <returns></returns>
		public abstract void Append(DGByteBuffer bbf);
		...
		/// <param name="bbf"></param>
		/// <returns></returns>
		public abstract void Pop(DGByteBuffer bbf);
