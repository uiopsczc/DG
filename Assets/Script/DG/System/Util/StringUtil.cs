...
namespace DG
{
    public static class StringUtil
    {
        ...
        public static (string mainPart, string cfgPart) GetLineAutoGenLineInfoParts(string mainPart,
            string cfgPartStartsWith)
        {
...
//		}
        ...
        public static string GetUITextOfColorAndFontSize(string content, Color? color = null, int? fontSize = null)
        {
            if (color.HasValue)
            {
                ...
                content = Regex.Replace(content, StringConst.STRING_REGEX_TEXT_COLOR_WARP_START,
            ...
            if (fontSize.HasValue)
            {
                ...
                content = Regex.Replace(content, StringConst.STRING_REGEX_TEXT_FONT_SIZE_WARP_START,
                    StringConst.STRING_EMPTY);
