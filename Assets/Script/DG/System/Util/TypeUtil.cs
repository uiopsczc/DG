...
namespace DG
{
    public partial class TypeUtil
    {
        public static Type GetType(string classPath, string dllName = null)
        {
            ...
            if (dllName == null && GetName2TypeCache().TryGetValue(classPath, out var value1))
                return value1;
            ...
            if (GetName2TypeCache().TryGetValue(typeString, out var value2))
                return value2;
            ...
            if (dllName == null) //查找所有assembly中的类
            {
                ...
                for (var i = 0; i < assemblies.Length; i++)
                {
                    ...
                    GetName2TypeCache()[StringUtil.LinkStringWithCommon(classPath, assembly.FullName)] = result;
                    break;
                }
            }

            GetName2TypeCache()[StringUtil.LinkStringWithCommon(classPath, dllName ?? StringConst.STRING_EMPTY)] =
                result;
            return result;
        }
