...
namespace DG
{
    ...
    public class AOPHandler : ISingleton
    {
        ...
        private readonly Dictionary<MethodBase, List<AOPAttributeMethodInfoProxyCategory>>
            _methodBase2AopAttributeMethodInfoProxyCategoryCache = new();
            ...
            MethodBase sourceMethodBase)
        {
            ...
            var result = _methodBase2AopAttributeMethodInfoProxyCategoryCache.GetOrAddByDefaultFunc(sourceMethodBase,
            ...
            params object[] sourceMethodArgs)
        {
            ...
            //缓存目标函数以备下次使用
            aopAttributeMethodInfoProxyCategory.aopMethodType2MethodInfoProxy[aopMethodType] = targetMethodInfoProxy;
            ...
            params Type[] sourceMethodParameterTypes)
        {
            ...
            if (aopAttributeMethodInfoProxyCategory.aopMethodType2MethodInfoProxy.TryGetValue(aopMethodType,
                    out var proxy))
                return proxy;
