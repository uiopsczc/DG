...
namespace DG
{
    public static class System_Object_Extension
    {
        ...
        /// </summary>
        public static Dictionary<T, V> ToDictionaryOrToDefault<T, V>(this object self,
            Dictionary<T, V> defaultValue = null)
        {
        ...
        /// </summary>
        public static Dictionary<T, V>[] ToDictionarysOrToDefault<T, V>(this object self,
            Dictionary<T, V>[] defaultValue = null)
        {
        ...
        public static T InvokeExtensionGenericMethod<T>(this object self, string methodName, Type[] genericTypes,
            ...
            params object[] parameters)
        {
            return ObjectUtil.InvokeExtensionGenericMethod<T>(self, methodName, genericTypes, isMissNotInvoke,
                parameters);
        }
