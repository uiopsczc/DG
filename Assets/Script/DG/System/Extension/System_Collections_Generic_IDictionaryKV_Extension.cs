...
namespace DG
{
    public static class System_Collections_Generic_IDictionaryKV_Extension
    {
        ...
        public static V GetOrGetByNewFunc<K, V>(this IDictionary<K, V> self, K key, Func<V> newFunc = null)
            where V : new()
        {
        ...
        public static V GetOrAddByNewFunc<K, V>(this IDictionary<K, V> self, K key, Func<V> newFunc = null)
            where V : new()
        {
        ...
        {
            return IDictionaryKVUtil.RandomList(self, outCount, isUnique, randomManager);
        }

        public static T Random<T>(IDictionary<T, float> self, RandomManager randomManager)
        {
            return IDictionaryKVUtil.Random(self, randomManager);
        }
