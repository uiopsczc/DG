...
//		}
        ...
        public static (string mainPart, string cfgPart) GetLineAutoGenLineInfoParts(this string mainPart,
...
//		}
        ...
        {
            return StringUtil.ToDictionary<TKey, TValue>(self, split, subSeparator, trimLeft, trimRight,
                elementIgnoreLeft, elementIgnoreRight);
        }
