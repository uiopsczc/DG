...
namespace DG
{
    public static class System_Collections_Generic_IListT_Extension
    {
        ...
        /// <returns></returns>
        public static List<T> RandomList<T>(this IList<T> self, int count, bool isUnique, IList<float> weights = null)
        {
            return IListTUtil.RandomList(self, count, isUnique, weights);
        }

        public static T[] RandomArray<T>(this IList<T> self, int count, bool isUnique, IList<float> weights = null)
        {
