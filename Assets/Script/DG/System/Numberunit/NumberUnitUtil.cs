...
namespace DG
{
    public static class NumberUnitUtil
    {
        ...
        public static long GetNumber(float num, string numberUnit = null,
            Dictionary<string, NumberUnitInfo> unit2NumberUnitInfo = null)
        {
            unit2NumberUnitInfo ??= NumberUnitConst.Unit2NumberUnitInfo;
            var zhiShu = 0; // 指数
            if (!numberUnit.IsNullOrWhiteSpace())
            {
                var numberUnitInfo = unit2NumberUnitInfo[numberUnit];
