...
namespace DG
{
	public class GUILayoutBeginScrollViewScope : IDisposable
	{
		...
		public GUILayoutBeginScrollViewScope(ref Vector2 scrollPosition, bool alwaysShowHorizontal,
			bool alwaysShowVertical,
			params GUILayoutOption[] options)
		{
			scrollPosition =
				GUILayout.BeginScrollView(scrollPosition, alwaysShowHorizontal, alwaysShowVertical, options);
		}
