...
namespace DG
{
	internal static class FPConstInternal
	{
		...
		public static readonly long
			SCALED_DEG2RAD = (long) (0.01745329f * SCALED_ONE); //Mathf.Deg2Rad == PI * 2F / 360F
		...
		internal const long
			SCALED_LARGE_PI =
				7244019458077122842; //跟这个差不多(long)(Math.PI * (1L << (NUM_BIT_COUNT - MOVE_BIT_COUNT - 3 + MOVE_BIT_COUNT))) == 7244019458077122560; 但是还是最后三位有区别，不然有误差
