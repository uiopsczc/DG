...
{
	[MenuItem(DGToolConst.Menu_Root + "GroupGameObjects/Group打包(中心) %g")] //crtl+g
	public static void GroupGameObject_Center()
	{
		...
		if (max == Vector3Const.MIN)
		{
			DGLog.Error("没有Meshes");
			return;
		}
		...
		DGLog.Info("GroupGameObjects finished");
	}
	...
	[MenuItem(DGToolConst.Menu_Root + "GroupGameObjects/Group打包(非中心) &g")] //alt+g
	...
	[MenuItem(DGToolConst.Menu_Root + "GroupGameObjects/Group打包(解除Group) %&g")] //crtl+alt+g
