...
namespace DG
{
	...
	public partial class DGToolMenu
	{
		...
		///   _t:t
		/// </summary>
		[MenuItem(DGToolConst.Menu_Root + "辅助工具/显示时间设置 %&#t")]
		//crtl+alt+shift+t
		...
		[MenuItem(DGToolConst.Asset_Menu_Root + "辅助工具/复制路径(相对于Project) %&#p")] //crtl+alt+shift+p  %&#p 
		[MenuItem(DGToolConst.GameObject_Menu_Root + "辅助工具/复制路径")]
		...
		[MenuItem(DGToolConst.Asset_Menu_Root + "辅助工具/复制Resource路径")]
