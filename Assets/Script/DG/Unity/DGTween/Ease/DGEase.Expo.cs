...
namespace DG
{
    ...
    // d 总时长
    public partial class DGEase
    {
        public class Expo : DGEase
        {
            ...
            {
                return EaseIn(startValue, endValue - startValue, pct, 1);
            }

            public static float EaseOut2(float startValue, float endValue, float pct)
            {
                return EaseOut(startValue, endValue - startValue, pct, 1);
            }

            public static float EaseInOut2(float startValue, float endValue, float pct)
            {
                return EaseInOut(startValue, endValue - startValue, pct, 1);
            }
        }
    }
}