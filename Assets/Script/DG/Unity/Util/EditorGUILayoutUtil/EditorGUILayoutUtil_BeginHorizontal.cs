...
namespace DG
{
	public partial class EditorGUILayoutUtil
	{
		...
		public static EditorGUILayoutBeginHorizontalScope BeginHorizontal(GUIStyle style,
			params GUILayoutOption[] options)
		{
			return new EditorGUILayoutBeginHorizontalScope(style, options);
		}

		public static EditorGUILayoutBeginHorizontalScope BeginHorizontal(ref Rect rect,
			params GUILayoutOption[] options)
		{
