    ...
    public partial class TransformUtil
    {
                ...
                ETransformMode.localPosition | ETransformMode.localRotation | ETransformMode.localScale)
        {
            ...
            if (transform.GetComponent<RectTransform>() != null &&
                targetTransform.GetComponent<RectTransform>() != null)
            ...
            switch (aix)
            {
                case AxisConstraint.X:
                    sequence.Append(DOTween
                        .To(() => transform.position, x => transform.position = x, new Vector3(0, endValue.y, 0.0f),
                            duration)
                ...
                case AxisConstraint.Y:
                    sequence.Append(DOTween
                        .To(() => transform.position, x => transform.position = x, new Vector3(endValue.x, 0.0f, 0.0f),
                            duration)
