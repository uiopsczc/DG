...
namespace DG
{
    public static partial class GUIStyleConst
    {
        ...
        public static GUIStyle GraphDeleteButtonStyle =>
            _Graph_Delete_Button_Style ??= editor_skin_dark.FindStyle("PixelButton");

        private static GUIStyle _Graph_Info_Button_Style;

        public static GUIStyle GraphInfoButtonStyle =>
            _Graph_Info_Button_Style ??= editor_skin_dark.FindStyle("InfoButton");

        private static GUIStyle _Graph_Gizmo_Button_Style;

        public static GUIStyle GraphGizmoButtonStyle =>
            _Graph_Gizmo_Button_Style ??= editor_skin_dark.FindStyle("GizmoButton");
        ...
        public static GUIStyle Horizontal_Slider_Style =>
            _Horizontal_Slider_Style ??= editor_skin_dark.FindStyle("horizontalslider");
        ...
        public static GUIStyle Vertical_Slider_Style =>
            _Vertical_Slider_Style ??= editor_skin_dark.FindStyle("verticalslider");

        private static GUIStyle _Horizontal_Scrollbar_Style;

        public static GUIStyle Horizontal_Scrollbar_Style =>
            _Horizontal_Scrollbar_Style ??= editor_skin_dark.FindStyle("horizontalscrollbar");

        private static GUIStyle _Vertical_Scrollbar_Style;

        public static GUIStyle Vertical_Scrollbar_Style =>
            _Vertical_Scrollbar_Style ??= editor_skin_dark.FindStyle("verticalscrollbar");
        ...
        public static GUIStyle Collision_Header_Style =>
            _Collision_Header_Style ??= editor_skin_dark.FindStyle("CollisionHeader");
        ...
        public static GUIStyle Pixel_Box3_Separator_Style =>
            _Pixel_Box3_Separator_Style ??= editor_skin_dark.FindStyle("PixelBox3Separator");
