...
//			else
			{
				...
				DGFixedPoint invNorm = (DGFixedPoint) 1.0f / DGFixedPointMath.Sqrt(ls);
...
//			}
			...
			if (DGFixedPointMath.Abs(f - (DGFixedPoint) 1.0f) < DGFixedPointMath.Epsilon)
			{
				return value; // It already normalized, so we don't need to further process.
			}

			DGFixedPoint fInv = (DGFixedPoint) 1.0f / DGFixedPointMath.Sqrt(f);
...
//			}
		...
		*************************************************************************************/
		...
		public bool Raycast(DGRay ray, out DGFixedPoint enter)
		{
			...
			if (DGFixedPointMath.IsApproximatelyZero(a))
			{
