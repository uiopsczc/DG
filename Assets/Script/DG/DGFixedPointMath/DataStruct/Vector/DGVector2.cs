		...
		*************************************************************************************/
		...
		public static DGVector2 MoveTowards(DGVector2 current, DGVector2 target, DGFixedPoint maxDistanceDelta)
		{
			...
			if (sqrtDistance == DGFixedPoint.Zero ||
				...
				return target;
			DGFixedPoint num4 = DGFixedPointMath.Sqrt(sqrtDistance);
			...
			DGFixedPoint smoothTime, DGFixedPoint maxSpeed, DGFixedPoint deltaTime)
		{
			...
			{
				var mag = DGFixedPointMath.Sqrt(sqDist);
		...
		public static DGFixedPoint SignedAngle(DGVector2 from, DGVector2 to)
		{
			...
			DGFixedPoint sign = (DGFixedPoint)DGFixedPointMath.Sign(from.x * to.y - from.y * to.x);
		...
		public static DGFixedPoint Distance(DGVector2 a, DGVector2 b)
		{
			...
			return DGFixedPointMath.Sqrt(diffX * diffX + diffY * diffY);
		}
		...
		{
			return DGFixedPointMath.Sqrt(vector.x * vector.x + vector.y * vector.y);
		}

		public static DGVector2 Min(DGVector2 value1, DGVector2 value2)
		{
			return new DGVector2(DGFixedPointMath.Min(value1.x, value2.x), DGFixedPointMath.Min(value1.y, value2.y));
		}

		public static DGVector2 Max(DGVector2 value1, DGVector2 value2)
		{
			return new DGVector2(DGFixedPointMath.Max(value1.x, value2.x), DGFixedPointMath.Max(value1.y, value2.y));
		}
