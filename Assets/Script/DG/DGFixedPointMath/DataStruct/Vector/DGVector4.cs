...
namespace DG
{
	public struct DGVector4
	{
		...
		public DGFixedPoint magnitude => DGFixedPointMath.Sqrt(sqrMagnitude);
		...
		*************************************************************************************/
		...
		{
			return DGFixedPointMath.IsApproximatelyZero((DGFixedPoint)1 - vector.x * vector.x - vector.y * vector.y - vector.z * vector.z -
											  vector.w * vector.w);
		}
		...
		{
			return DGFixedPointMath.Sqrt(vector.x * vector.x + vector.y * vector.y + vector.z * vector.z + vector.w * vector.w);
		}
		...
		public static DGFixedPoint Distance(DGVector4 a, DGVector4 b)
		{
			...
			return DGFixedPointMath.Sqrt(diffX * diffX + diffY * diffY + diffZ * diffZ + diffW * diffW);
		}
		...
		{
			return new DGVector4(DGFixedPointMath.Min(value1.x, value2.x), DGFixedPointMath.Min(value1.y, value2.y),
				DGFixedPointMath.Min(value1.z, value2.z), DGFixedPointMath.Min(value1.w, value2.w));
		}

		public static DGVector4 Max(DGVector4 value1, DGVector4 value2)
		{
			return new DGVector4(DGFixedPointMath.Max(value1.x, value2.x), DGFixedPointMath.Max(value1.y, value2.y),
				DGFixedPointMath.Max(value1.z, value2.z), DGFixedPointMath.Max(value1.w, value2.w));
		}

		public static DGVector4 Abs(DGVector4 value)
		{
			return new DGVector4(DGFixedPointMath.Abs(value.x), DGFixedPointMath.Abs(value.y), DGFixedPointMath.Abs(value.z), DGFixedPointMath.Abs(value.w));
		}
