	...
	public struct DGMatrix3x2
	{
		...
		*************************************************************************************/
		...
		public static DGMatrix3x2 CreateSkew(DGFixedPoint radiansX, DGFixedPoint radiansY)
		{
			...
			DGFixedPoint xTan = DGFixedPointMath.Tan(radiansX);
			DGFixedPoint yTan = DGFixedPointMath.Tan(radiansY);
		...
		public static DGMatrix3x2 CreateRotation(DGFixedPoint radians)
		{
			...
			radians = DGFixedPointMath.IEEERemainder(radians, DGFixedPointMath.PI * (DGFixedPoint)2);

			DGFixedPoint c, s;

			DGFixedPoint epsilon = (DGFixedPoint)0.001f * DGFixedPointMath.PI / (DGFixedPoint)180f; // 0.1% of a degree
			...
			else if (radians > DGFixedPointMath.PI / (DGFixedPoint)2 - epsilon && radians < DGFixedPointMath.PI / (DGFixedPoint)2 + epsilon)
			{
				// Exact case for 90 degree rotation.
				c = (DGFixedPoint)0;
				s = (DGFixedPoint)1;
			}
			else if (radians < -DGFixedPointMath.PI + epsilon || radians > DGFixedPointMath.PI - epsilon)
			{
			...
			{
				// Arbitrary rotation.
				c = DGFixedPointMath.Cos(radians);
				s = DGFixedPointMath.Sin(radians);
			}
