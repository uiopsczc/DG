...
namespace DG
{
	...
	public partial struct DGMatrix3x3
	{
		...
		{
			return setToRotationRad(DGFixedPointMath.Deg2Rad * degrees);
		}
		...
		{
			return setToRotation(axis, DGFixedPointMath.CosDeg(degrees), DGFixedPointMath.SinDeg(degrees));
		}
		...
		{
			return rotateRad(DGFixedPointMath.Deg2Rad * degrees);
		}
		...
		{
			scale.x = DGFixedPointMath.Sqrt(this.m00 * this.m00 + this.m01 * this.m01);
			scale.y = DGFixedPointMath.Sqrt(this.m10 * this.m10 + this.m11 * this.m11);
			return scale;
		}

		public DGFixedPoint getRotation()
		{
			return DGFixedPointMath.Rad2Deg * DGFixedPointMath.Atan2(this.m10, this.m00);
		}

		public DGFixedPoint getRotationRad()
		{
			return DGFixedPointMath.Atan2(this.m10, this.m00);
		}
