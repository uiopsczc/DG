...
public partial struct DGAffine2
{
	 ...
	 * @return This matrix for the purposes of chaining. */
	public DGAffine2 set(FPMatrix3x3 matrix)
	{
		FP[] other = matrix.val;

		m00 = other[FPMatrix3x3.M00];
		m01 = other[FPMatrix3x3.M01];
		m02 = other[FPMatrix3x3.M02];
		m10 = other[FPMatrix3x3.M10];
		m11 = other[FPMatrix3x3.M11];
		m12 = other[FPMatrix3x3.M12];
		return this;
	}
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 set(FPMatrix4x4 matrix)
	{
		FP[] other = matrix.val;

		m00 = other[FPMatrix4x4.M00];
		m01 = other[FPMatrix4x4.M01];
		m02 = other[FPMatrix4x4.M03];
		m10 = other[FPMatrix4x4.M10];
		m11 = other[FPMatrix4x4.M11];
		m12 = other[FPMatrix4x4.M13];
		return this;
	}
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTranslation(FP x, FP y)
	{
		m00 = (FP) 1;
		m01 = (FP) 0;
		m02 = x;
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTranslation(FPVector2 trn)
	{
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToScaling(FP scaleX, FP scaleY)
	{
		m00 = scaleX;
		m01 = (FP) 0;
		m02 = (FP) 0;
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToScaling(FPVector2 scale)
	{
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToRotation(FP degrees)
	{
		FP cos = DGMath.CosDeg(degrees);
		FP sin = DGMath.SinDeg(degrees);
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToRotationRad(FP radians)
	{
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToRotation(FP cos, FP sin)
	{
		m00 = cos;
		m01 = -sin;
		m02 = (FP) 0;
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToShearing(FP shearX, FP shearY)
	{
		m00 = (FP) 1;
		m01 = shearX;
		m02 = (FP) 0;
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToShearing(FPVector2 shear)
	{
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTrnRotScl(FP x, FP y, FP degrees, FP scaleX, FP scaleY)
	{
		m02 = x;
		m12 = y;
	 ...
	 * @param scale The scale vector.
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTrnRotScl(FPVector2 trn, FP degrees, FPVector2 scale)
	{
	 ...
	 * @param scaleY The scale in x.
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTrnRotRadScl(FP x, FP y, FP radians, FP scaleX, FP scaleY)
	{
		m02 = x;
		m12 = y;
	 ...
	 * @param scale The scale vector.
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTrnRotRadScl(FPVector2 trn, FP radians, FPVector2 scale)
	{
	 ...
	 * @param scaleY The scale in x.
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTrnScl(FP x, FP y, FP scaleX, FP scaleY)
	{
		m00 = scaleX;
		m01 = (FP) 0;
		m02 = x;
	 ...
	 * @param scale The scale vector.
	 * @return This matrix for the purpose of chaining operations. */
	public DGAffine2 setToTrnScl(FPVector2 trn, FPVector2 scale)
	{
	...
	{
		FP det = this.det();
		if (det == (FP) 0) throw new Exception("Can't invert a singular affine matrix");
	...
	public DGAffine2 translate(FP x, FP y)
	{
		m02 += m00 * x + m01 * y;
		m12 += m10 * x + m11 * y;
		return this;
	 ...
	 * @param trn The translation vector.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 translate(FPVector2 trn)
	{
	 ...
	 * @param y The y-component of the translation vector.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preTranslate(FP x, FP y)
	{
		m02 += x;
		m12 += y;
		return this;
	 ...
	 * @param trn The translation vector.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preTranslate(FPVector2 trn)
	{
	 ...
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 scale(FP scaleX, FP scaleY)
	{
		m00 *= scaleX;
		m01 *= scaleY;
		m10 *= scaleX;
	 ...
	 * @param scale The scale vector.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 scale(FPVector2 scale)
	{
	 ...
	 * @param scaleY The scale in the y-axis.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preScale(FP scaleX, FP scaleY)
	{
		m00 *= scaleX;
		m01 *= scaleX;
		m02 *= scaleX;
	 ...
	 * @param scale The scale vector.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preScale(FPVector2 scale)
	{
	 ...
	 * @param degrees The angle in degrees
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 rotate(FP degrees)
	{
	 ...
	 * @param radians The angle in radians
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 rotateRad(FP radians)
	{
	 ...
	 * @param degrees The angle in degrees
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preRotate(FP degrees)
	{
		if (degrees == (FP) 0) return this;
	 ...
	 * @param radians The angle in radians
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preRotateRad(FP radians)
	{
		if (radians == (FP) 0) return this;
	 ...
	 * @param shearY The shear in y direction.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 shear(FP shearX, FP shearY)
	{
	 ...
	 * @param shear The shear vector.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 shear(FPVector2 shear)
	{
	 ...
	 * @param shearY The shear in y direction.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preShear(FP shearX, FP shearY)
	{
	 ...
	 * @param shear The shear vector.
	 * @return This matrix for the purpose of chaining. */
	public DGAffine2 preShear(FPVector2 shear)
	{
	...
	{
		return (m00 == (FP) 1 && m11 == (FP) 1 && m01 == (FP) 0 && m10 == (FP) 0);
	}
	...
	public bool isIdt()
	{
		return (m00 == (FP) 1 && m02 == (FP) 0 && m12 == (FP) 0 && m11 == (FP) 1 && m01 == (FP) 0 && m10 == (FP) 0);
	}
