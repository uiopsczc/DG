...
public DGVector3 getCorner000(DGVector3 outCorner)
{
...
private void update()
{
	...
	axes[0].set(transform.m00, transform.m10, transform.m20).nor();
	axes[1].set(transform.m01, transform.m11, transform.m21).nor();
	axes[2].set(transform.m02, transform.m12, transform.m22).nor();
